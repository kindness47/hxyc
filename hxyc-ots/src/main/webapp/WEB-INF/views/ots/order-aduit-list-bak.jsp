...
<div class="page-container">
    ...
    <div class="mt-20" id="fukuaninfo">
        ...
        <table id="" class="table table-border table-bordered table-hover table-bg" style="width: 1700px;">
            <thead>
            <tr class="text-c">
                <th width="50">序号</th>
            ...
            <c:forEach items="${daigouFukuanVOList}" var="receipt"  varStatus="rstatus">
                <tr class="text-c">
                    ...
                    <td><f:formatDate value="${receipt.receiptTime}" pattern="MM-dd"/></td>
                    <td><f:formatDate value="${receipt.billOpenTime}" pattern="MM-dd"/></td>
                    <td><c:if test="${1==receipt.billOpenStatus}"><span style="color: green">√</span></c:if><c:if test="${2==receipt.billOpenStatus}"><a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="${receipt.billOpenRemark}"><span style="color: red">×</span></a></c:if></td>
                    <td><f:formatDate value="${receipt.approvalTime}" pattern="MM-dd"/></td>
                    <td>
                    ...
                    <td><f:formatDate value="${receipt.paymentTime}" pattern="MM-dd"/></td>
                    <td>
                    ...
                    <td>${receipt.creditSurplusAmount}</td>
                    <td><a href="javascript:void(0);" class="remark" data-toggle="tooltip" data-placement="top" title="${receipt.remarks}">${receipt.remarks}</a></td>
                </tr>
            </c:forEach>
    ...
    <div class="clearfix"> </div>
        <div class="mt-20">
            <table id="orderAduitTable" class="table table-border table-bordered table-hover table-bg table-sort" style="width: 1700px;">
                <thead>
                <tr class="text-c">
