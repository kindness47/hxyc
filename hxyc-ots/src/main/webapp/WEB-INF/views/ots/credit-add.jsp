...
<article class="page-container">
	<form class="form form-horizontal" id="form-credit-add" name="creditForm">
		<input type="hidden" id="id" name="id" value="${credit.id}">
		<input type="hidden" id="companyId" name="companyId" value="${credit.companyId}">
		<input type="hidden" id="projectId" name="projectId" value="${credit.projectId}">
		<input type="hidden" id="creditType" name="creditType" value="${credit.creditType}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" style="text-align: right">
				<div id="openCreditDiv" ></div>
			</label>
			<div id="companyNameDiv" class="formControls col-xs-8 col-sm-9" ></div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" style="text-align: right"><span class="c-red">*</span>开证金额：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="请输入开证金额" id="openAmount" name="openAmount" value="${credit.openAmount}" style="width: 85%"> 万元
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" style="text-align: right"><span class="c-red">*</span>开证日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text Wdate" placeholder="请输入开证日期" id="openTime" name="openTime" value="${credit.openTime}"  readonly  onclick="WdatePicker()"  style="width: 85%">
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input id="saveBtn" class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
