...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 订单跟踪 <span class="c-gray en">&gt;</span> 结算管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" onclick="location.replace(location.href)" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <a href="javascript:;" onclick="settlement_add('新增结算','settlement-add','','520')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 新增结算</a>
    </div>
        ...
        <div class="mt-20">
            <table id="settlementTable" class="table table-border table-bordered table-hover table-bg table-sort">
                ...
                <c:forEach items="${settlementVOList}" var="settlementVO">
                    <tr class="text-c">
                        <td>
                            <a title="编辑" href="javascript:;" onclick="settlement_edit('编辑','settlement-edit?id=${settlementVO.id}','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                        </td>
