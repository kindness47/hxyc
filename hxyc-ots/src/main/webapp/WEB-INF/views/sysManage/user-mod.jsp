...
<article class="page-container">
	<form class="form form-horizontal" id="form-user-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" style="text-align: right">用户名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" id="userName" name="userName" value="${user.userName}" disabled>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" style="text-align: right">用户账号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" id="account" name="account" value="${user.account}" disabled>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" for="oldPasswd" style="text-align: right"><span class="c-red">*</span>旧密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text password" autocomplete="off"  placeholder="请输入旧密码" id="oldPasswd" name="oldPasswd">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" for="newPasswd" style="text-align: right"><span class="c-red">*</span>新密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text password" autocomplete="off" placeholder=" 请输入新密码" id="newPasswd" name="newPasswd">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" for="confPasswd" style="text-align: right"><span class="c-red">*</span>确认密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text password" autocomplete="off" placeholder=" 请确认密码" id="confPasswd" name="confPasswd">
			</div>
		</div>
		<div class="row cl">
